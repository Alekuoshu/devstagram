<div>
    @auth
        ...
        <div class="mb-5">
            ...
            <textarea wire:model="comentario" id="comentario" name="comentario" type="text" placeholder="Agrega un comentario"
        ...
        <button wire:click="store"
            class="bg-sky-700 hover:bg-sky-700 transition-colors cursor-pointer font-bold w-full p-3 text-white rounded-lg">
            Comentar
        </button>
    @endauth
